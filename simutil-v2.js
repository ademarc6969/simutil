import {bd as ko, r as Nt, u as Vn, aZ as Co, Q as jn, n as ue, aI as Mn, aw as Ro, l as dt, aB as De, t as Io, W as gt, aQ as ze, a as sr, ae as Vr, R as Gn, g as be, T as Br, d as Pn, o as Fo, j as jr, aL as Mo, h as Ln, ax as Yn, I as Ur, E as Bn} from "https://labsimapp.testout.com/v6_0_672/assets/authenticationservice-CPHNDjIl.js";
import {C as $n} from "https://labsimapp.testout.com/v6_0_672/assets/compressedstrings-f-RzZfLK.js";
function Ko(d) {
...
`; )
                ...
                if (x == "_" || I.isLetter(x.charCodeAt(0))) {
                    ...
                    if (x == "(") {
                        ...
                        if (G == "processing-instruction") {
                            m.charAt(h) == ")" ? i.push(v.NODETYPE) : i.push(v.PROCESSINGINSTRUCTIONWITHLITERAL),
                            c.push(G);
                            continue
                        }
                        i.push(v.FUNCTIONNAME),
            ...
            if (m != null) {
                ...
                G = c[h++]; ; )
                    ...
                    case v.SHIFT:
                        k.push(-D),
                        Q.push(G),
                        x.push(v.actionTableNumber[nt].charCodeAt(D - 1) - 32),
                        D = i[h],
                        G = c[h++];
                        break;
                    case v.REDUCE:
                        for (var Ct = v.productions[v.actionTableNumber[nt].charCodeAt(D - 1) - 32][1], S = [], ie = 0; ie < Ct; ie++)
                            k.pop(),
                            S.unshift(Q.pop()),
                            x.pop();
                        var ae = x[x.length - 1];
                        k.push(v.productions[v.actionTableNumber[nt].charCodeAt(D - 1) - 32][0]),
                        this.reduceActions[v.actionTableNumber[nt].charCodeAt(D - 1) - 32] == null ? Q.push(S[0]) : Q.push(this.reduceActions[v.actionTableNumber[nt].charCodeAt(D - 1) - 32](S)),
                        x.push(v.gotoTable[ae].charCodeAt(v.productions[v.actionTableNumber[nt].charCodeAt(D - 1) - 32][0] - 2) - 33);
                        break;
                    case v.ACCEPT:
                        return new et(Q.pop());
                    default:
        ...
        H.prototype.toString = function() {
            ...
            return t.indexOf("e-") !== -1 ? xr(t) : t.indexOf("e") !== -1 ? vr(t) : t
        }
        ,
...
(Hr = Jn).exports = function() {
    ...
    function yt(e, r) {
        ...
        return P(function() {
            ...
            n) {
                var o, l, g, w = [], F = arguments.length;
                for (l = 0; l < F; l++) {
                    if (o = "",
...
` + new Error().stack),
    ...
    function Qt(e) {
        var r, n;
        for (n in e)
            y(e, n) && (vt(r = e[n]) ? this[n] = r : this["_" + n] = r);
        this._config = e,
    ...
    function R(e, r, n, o) {
        ...
        return vt(l) ? l(e, r, n, o) : l.replace(/%d/i, e)
    }
    function zt(e, r) {
        var n = this._relativeTime[e > 0 ? "future" : "past"];
        return vt(n) ? n(r) : n.replace(/%s/i, r)
    }
    var Ut = {
        D: "date",
        dates: "date",
    ...
    function Xr(e, r, n) {
        ...
        if (e.isValid() && !isNaN(n)) {
            ...
            g = n,
            w = e.month(),
            F = (F = e.date()) !== 29 || w !== 1 || z(g) ? F : 28,
            l ? o.setUTCFullYear(g, w, F) : o.setFullYear(g, w, F)
        }
    }
    function rs(e) {
        return vt(this[e = xt(e)]) ? this[e]() : this
    }
    function ns(e, r) {
        if (typeof e == "object") {
    ...
    function cs(e, r, n) {
        var o, l, g, w = e.toLocaleLowerCase();
        ...
        return n ? r === "MMM" ? (l = bt.call(this._shortMonthsParse, w)) !== -1 ? l : null : (l = bt.call(this._longMonthsParse, w)) !== -1 ? l : null : r === "MMM" ? (l = bt.call(this._shortMonthsParse, w)) !== -1 || (l = bt.call(this._longMonthsParse, w)) !== -1 ? l : null : (l = bt.call(this._longMonthsParse, w)) !== -1 || (l = bt.call(this._shortMonthsParse, w)) !== -1 ? l : null
    }
    function hs(e, r, n) {
        var o, l, g;
    ...
    function ms(e, r, n, o, l, g, w) {
        var F;
        return e < 100 && e >= 0 ? (F = new Date(e + 400,r,n,o,l,g,w),
        isFinite(F.getFullYear()) && F.setFullYear(e)) : F = new Date(e,r,n,o,l,g,w),
        F
    }
    function $e(e) {
        var r, n;
    ...
    function en(e, r, n, o, l) {
        var g, w, F = 1 + 7 * (r - 1) + (7 + n - o) % 7 + ir(e, o, l);
        return F <= 0 ? w = je(g = e - 1) + F : F > je(e) ? (g = e + 1,
        w = F - je(e)) : (g = e,
        w = F),
        {
            year: g,
    ...
    function qe(e, r, n) {
        var o, l, g = ir(e.year(), r, n), w = Math.floor((e.dayOfYear() - g - 1) / 7) + 1;
        return w < 1 ? o = w + he(l = e.year() - 1, r, n) : w > he(e.year(), r, n) ? (o = w - he(e.year(), r, n),
        l = e.year() + 1) : (l = e.year(),
        o = w),
        {
            week: o,
    ...
    B("k", ["kk", 2], 0, Us),
    B("hmm", 0, 0, function() {
        return "" + Er.apply(this) + wt(this.minutes(), 2)
    }),
    B("hmmss", 0, 0, function() {
        return "" + Er.apply(this) + wt(this.minutes(), 2) + wt(this.seconds(), 2)
    }),
    B("Hmm", 0, 0, function() {
    ...
    function Qs(e, r) {
        if (r != null) {
            ...
            e === ve() && ve(e)) : mt[e] != null && delete mt[e]);
        return mt[e]
    }
    function fe(e) {
        var r;
    ...
    function un(e) {
        var r, n, o, l, g, w, F = e._i, L = Js.exec(F) || zs.exec(F), ot = or.length, Dt = Nr.length;
        if (L) {
            for (O(e).iso = !0,
            r = 0,
            n = ot; r < n; r++)
    ...
    function ri(e, r, n, o, l, g) {
        var w = [ni(e), Jr.indexOf(r), parseInt(n, 10), parseInt(o, 10), parseInt(l, 10)];
    ...
    function Dr(e) {
        ...
        if (!e._d) {
            ...
            e._a[St] = 0),
            e._d = (e._useUTC ? $e : ms).apply(null, w),
    ...
    function li(e) {
        ...
        (r.e < 0 || r.e > 6) && (L = !0)) : l = g),
        o < 1 || o > he(n, g, w) ? O(e)._overflowWeeks = !0 : L != null ? O(e)._overflowWeekday = !0 : (F = en(n, o, l, g, w),
        e._a[it] = F.year,
    ...
    function Or(e) {
        if (e._f !== a.ISO_8601)
            if (e._f !== a.RFC_2822) {
                e._a = [],
                O(e).empty = !0;
                var r, n, o, l, g, w, F, L = "" + e._i, ot = L.length, Dt = 0;
    ...
    function hi(e) {
        var r, n, o, l, g, w, F = !1, L = e._f.length;
        if (L === 0)
    ...
    function Si(e, r, n) {
        var o, l = Math.min(e.length, r.length), g = Math.abs(e.length - r.length), w = 0;
        for (o = 0; o < l; o++)
            Z(e[o]) !== Z(r[o]) && w++;
        return w + g
    }
    ...
    function ee(e, r) {
        var n, o, l, g = e, w = null;
        return lr(e) ? g = {
            ms: e._milliseconds,
            d: e._days,
            M: e._months
        } : A(e) || !isNaN(+e) ? (g = {},
        r ? g[r] = +e : g.milliseconds = +e) : (w = Mi.exec(e)) ? (n = w[1] === "-" ? -1 : 1,
        g = {
            y: 0,
            d: Z(w[qt]) * n,
            h: Z(w[St]) * n,
    ...
    function Ui(e) {
        return j(e) || Y(e) || vn(e) || A(e) || Hi(e) || Wi(e) || e == null
    }
    function Wi(e) {
        var r, n, o = p(e) && !_(e), l = !1, g = ["years", "year", "y", "months", "month", "M", "days", "day", "d", "dates", "date", "D", "hours", "hour", "h", "minutes", "minute", "m", "seconds", "second", "s", "milliseconds", "millisecond", "ms"], w = g.length;
        for (r = 0; r < w; r += 1)
            n = g[r],
            l = l || y(e, n);
        return o && l
    ...
    function Gi(e, r) {
        ...
        var n = e || ht()
          ...
          , g = r && (vt(r[l]) ? r[l].call(this, n) : r[l]);
    ...
    function ea(e) {
        ...
        return n.year() < 0 || n.year() > 9999 ? Bt(n, r ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : vt(Date.prototype.toISOString) ? r ? this.toDate().toISOString() : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace("Z", Bt(n, "Z")) : Bt(n, r ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ")
    }
    function ra() {
        if (!this.isValid())
    ...
    function ba(e, r, n) {
        var o, l, g, w, F, L = this.eras();
        for (e = e.toUpperCase(),
        o = 0,
        l = L.length; o < l; ++o)
            if (g = L[o].name.toUpperCase(),
            w = L[o].abbr.toUpperCase(),
    ...
    function Mr() {
        var e, r, n, o, l, g = [], w = [], F = [], L = [], ot = this.eras();
        for (e = 0,
        r = ot.length; e < r; ++e)
            n = Kt(ot[e].name),
            o = Kt(ot[e].abbr),
    ...
    function Pr(e, r, n, o) {
        ...
        r = void 0),
        r = r || "");
        var l, g = fe(), w = e ? g._week.dow : 0, F = [];
        if (n != null)
            return pr(r, (n + w) % 7, o, "day");
        for (l = 0; l < 7; l++)
            F[l] = pr(r, (l + w) % 7, o, "day");
        return F
    }
    function Xa(e, r) {
    ...
    a.lang = yt("moment.lang is deprecated. Use moment.locale instead.", ve),
    ...
    function no() {
        var e, r, n, o, l, g = this._milliseconds, w = this._days, F = this._months, L = this._data;
        return g >= 0 && w >= 0 && F >= 0 || g <= 0 && w <= 0 && F <= 0 || (g += 864e5 * Rn(Lr(F) + w),
        w = 0,
        F = 0),
    ...
    function To(e, r, n, o) {
        var l = ee(e).abs()
          ...
          , Dt = me(l.as("w"))
          , oe = me(l.as("y"))
          , Ne = g <= n.ss && ["s", g] || g < n.s && ["ss", g] || w <= 1 && ["m"] || w < n.m && ["mm", w] || F <= 1 && ["h"] || F < n.h && ["hh", F] || L <= 1 && ["d"] || L < n.d && ["dd", L];
    ...
    function mr() {
        if (!this.isValid())
            return this.localeData().invalidDate();
        var e, r, n, o, l, g, w, F, L = Yr(this._milliseconds) / 1e3, ot = Yr(this._days), Dt = Yr(this._months), oe = this.asSeconds();
        return oe ? (e = Ft(L / 60),
        r = Ft(e / 60),
        L %= 60,
        e %= 60,
        ...
        w = Le(this._days) !== Le(oe) ? "-" : "",
        F = Le(this._milliseconds) !== Le(oe) ? "-" : "",
        l + "P" + (n ? g + n + "Y" : "") + (Dt ? g + Dt + "M" : "") + (ot ? w + ot + "D" : "") + (r || e || L ? "T" : "") + (r ? F + r + "H" : "") + (e ? F + e + "M" : "") + (L ? F + o + "S" : "")) : "P0D"
    }
    var K = ur.prototype;
    return K.isValid = bi,
    K.abs = to,
...
class nr {
    ...
    static postResourceResult(s, a, u, f) {
        const p = $n.compress(JSON.stringify(a));
        return dt.post("/resourceResults/" + s.userProfileId + "/" + s.resultStorage + "/encoded", {
            value: p
        }, y => {
            isNaN(y) || (u && nr.updateResourceResultSummaryMap(a, u),
            f != null && f(y))
        }
        , {
            autoRetry: !0,
    ...
    static async buildLaunchUrls(s) {
        const {classProfileId: a, getContentPath: u, labSimBaseUrl: f, locale: p, i18n: y, paths: _, productVersionId: b, queryString: A="", resource: Y, tabInteropId: q, taskCompletionMask: P, taskSet: M, user: tt, returnToLab: O} = s
          ...
          , At = {
            ...
            dtval: Ln().add(7, "days").valueOf().toString(),
          ...
          , _t = this.buildLaunchUrl(Rt, et, v, At, A);
        At.taskCompletionMask = P;
        const j = this.buildLaunchUrl(Rt, et, v, At, A);
        return {
            launchFreshUrl: _t,
    ...
    static buildSimResponseFromDetails(s, a, u) {
        ...
        if (a) {
            ...
            for (let Y = 0, q = b.length; Y < q; Y++) {
                ...
                et === re.TopItemsWithoutGroups ? ft.buildAnswerDetails(P.TaskItems, v, u, !1, M) : et === re.TopItems ? ft.buildAnswerDetails(P.TaskItems, v, u, !0, M) : et === re.AllWithoutGroups ? ft.buildAnswerDetails(tt, v, u, !1, M) : ft.buildAnswerDetails(tt, v, u, !0, M),
                A += O,
          ...
          , p = function(A, Y, q, P) {
            ...
            for (; O < A.length; ) {
                if (P || A[O]instanceof ye) {
                    ...
                    gt.isNullOrEmpty(et) ? q && (v += "¿") : (v += M[tt],
                    tt++)
                }
                O++
            }
            ...
            for (let Y = 0, q = u.answers.length; Y < q; Y++) {
                ...
                tt.length > 0)
                    if (P.details.length === 0 && P.subTasks && P.subTasks.length > 0) {
                        ...
                        let O = 0;
                        const v = P.details.replace("|", "").split(`\r
`);
                        let et = !0;
